...
class TestBunny:
    ...
    def test_index(self):
        ...
        for b in bun2:
            assert (b.index ==
                    bunny.bunny._index(b.f2_dict, b.f1_dict, b.f0_dict, b.size))
        ind = 50
        b = show(ind, 3)
        assert bunny.bunny._index(b.f2_dict, b.f1_dict, b.f0_dict, 3) == ind
...
class TestInfBunny():
    ...
    def test_partial(self):
        ...
        assert self.bunny2.check_id(self.id1, 6, True)[1] == {'x': 0}
        assert self.bunny2.check_id(self.id2, 6, True)[0] == None
        assert self.bunny2.check_id(self.id2, 6, True)[1]
        
    def test_generate(self):
        d = {(0, 0): 0, (0, 1): 1}
        f2 = bunny.bunny._generate_f(d, str(d))
        try:
            f2(2, 0)
        except ArgError:
            pass
    ...
    def test_find4(self):
        ...
        id37 = bunny.identity.Identity.make_identity('-a=-(-a)')
        id57 = bunny.identity.Identity.make_identity('x=-(x*x)')
        id1 = bunny.identity.Identity.make_identity('x=x')
        id22 = bunny.identity.Identity.make_identity('a=a*(-(a))')
        id24 = bunny.identity.Identity.make_identity('a=(-a)*a')
        idn = bunny.identity.Identity.make_identity('x=y')
        #entspricht G_603 - G_618
    ...
    def test_find5(self):
        print '\ttest_find5\n'
        #x = (-x)*y => x = -(x*y)
        id58 = bunny.identity.Identity.make_identity('x=-(x*y)')
        id53 = bunny.identity.Identity.make_identity('x=(-x)*y')        
    ...
    def test_find7(self):
        print '\ttest_find7\n'
        id27 = bunny.identity.Identity.make_identity('a=x*(-x)')
        id31 = bunny.identity.Identity.make_identity('a=(-x)*y')
    ...
    def test_find9(self):
        ...
        id52 = bunny.identity.Identity.make_identity('x=(-x)*x')
        
        id8 = bunny.identity.Identity.make_identity('a=a*a')
    ...
    def test_find11(self):
        ...
        id3  = bunny.identity.Identity.make_identity('a=-a')
        id6  = bunny.identity.Identity.make_identity('a=-(-a)')
        id8  = bunny.identity.Identity.make_identity('a=a*a')
        id11 = bunny.identity.Identity.make_identity('a=x*x')
        id22 = bunny.identity.Identity.make_identity('a=a*(-a)')
        id20 = bunny.identity.Identity.make_identity('a=-(-(-a))')
        id24 = bunny.identity.Identity.make_identity('a=(-a)*a')
        id32 = bunny.identity.Identity.make_identity('a=-(a*a)')
        id35 = bunny.identity.Identity.make_identity('a=-(x*x)')
        id37 = bunny.identity.Identity.make_identity('-a=-(-a)')
        id39 = bunny.identity.Identity.make_identity('-a=a*a')
        id42 = bunny.identity.Identity.make_identity('-a=x*x')
        id47 = bunny.identity.Identity.make_identity('x=x*(-x)')
        id52 = bunny.identity.Identity.make_identity('x=(-x)*x')
        ...
        f1 = {'condition1': (lambda n: n >= 1, 
              ...
              0: 0, 1: 3}
        bun = InfBunny(f2, f1)
        print (bun.check_id(id3, 8, True), bun.check_id(id11, 8, True),
               bun.check_id(id35, 8, True), bun.check_id(id42, 8, True),
               bun.check_id(id47, 8, True), bun.check_id(id52, 8, True),
               bun.check_id(id55, 8, True))
    ...
    def test_find13(self):
        ...
        id6  = bunny.identity.Identity.make_identity('a=-(-a)')
        id24 = bunny.identity.Identity.make_identity('a=(-a)*a')
        id25 = bunny.identity.Identity.make_identity('a=(-a)*x')
        id32 = bunny.identity.Identity.make_identity('a=-(a*a)')
        id52 = bunny.identity.Identity.make_identity('x=(-x)*x')
        id57 = bunny.identity.Identity.make_identity('x=-(x*x)')
    ...
    def test_find14(self):
        ...
        id40 = bunny.identity.Identity.make_identity('-a=a*x')
    ...
    def test_find15(self):
        ...
        id32 = bunny.identity.Identity.make_identity('a=-(a*a)')
        id39 = bunny.identity.Identity.make_identity('-a=a*a')
        id46 = bunny.identity.Identity.make_identity('x=x*(-a)')
        id50 = bunny.identity.Identity.make_identity('x=(-a)*x')
        id55 = bunny.identity.Identity.make_identity('x=-(a*x)')
    ...
    def test_find17(self):
        ...
        id22 = bunny.identity.Identity.make_identity('a=a*(-a)')
        id24 = bunny.identity.Identity.make_identity('a=(-a)*a')
        id30 = bunny.identity.Identity.make_identity('a=(-x)*x')
        id32 = bunny.identity.Identity.make_identity('a=-(a*a)')
        id39 = bunny.identity.Identity.make_identity('-a=a*a')
        id50 = bunny.identity.Identity.make_identity('x=(-a)*x')
        id55 = bunny.identity.Identity.make_identity('x=-(a*x)')
        id64 = bunny.identity.Identity.make_identity('-x=x*a')
